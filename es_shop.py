...
templates = {
    ...
    'covenant' : cv2.cvtColor(cv2.imread("./covenant.png"), cv2.COLOR_BGR2GRAY),
    'refresh' : cv2.cvtColor(cv2.imread("./refresh.png"), cv2.COLOR_BGR2GRAY),
    'confirm' : cv2.cvtColor(cv2.imread("./confirm.png"), cv2.COLOR_BGR2GRAY)
}
